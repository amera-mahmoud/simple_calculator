...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/GPIO/gpio_hal.c" 2
# 1 "MCAL_Layer/GPIO/gpio_hal.h" 1
# 12 "MCAL_Layer/GPIO/gpio_hal.h"
...
# 12 "MCAL_Layer/GPIO/gpio_hal.h" 2

# 1 "MCAL_Layer/GPIO/../device_config.h" 1
# 13 "MCAL_Layer/GPIO/gpio_hal.h" 2
...
# 14 "MCAL_Layer/GPIO/gpio_hal.h" 2
...
{
    std_ReturnType ret = (std_ReturnType)0x00;
    if((((void*)0) == pin_config)||(((void*)0) == direction)||(pin_config->pin > 8 - 1))
    {
        ret = (std_ReturnType)0x00;
    }
    else
    {
        *direction = ((*tris_registers[pin_config->port] >> pin_config->pin) & (uint8)0x01);
        ret = (std_ReturnType)0x01;
    }
    return ret;
}
